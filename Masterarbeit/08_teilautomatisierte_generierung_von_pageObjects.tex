...
Das Modell des Generators bietet allerdings auch die möglichkeit die fertig aufgelösten Ausdrücke ohne die zusätzliche Verwendung der ByFactory zu erhalten.
Mit den Methoden  \grq Element.getXPath()\grq\ bzw.  \grq Element.getCssSelector()\grq\ können je nach verwendetem Selector der XPath bzw. der CssSelector als String erfragt werden. \\
...
Die Klasse ControlBys implementiert das Interface Control und kapselt ein Selenium WebElement. Als Referenz gegen die Webseite wir bei der Instanziierung ein By-Ausdruck übergeben der über die ByFactory erzeugt werden kann.
...
Die Kapselung eines WebElements in die Klasse ControlBys hat den Vorteil, dass WebElemente in einem PageObject als Klassenvariablen geführt werden können.
